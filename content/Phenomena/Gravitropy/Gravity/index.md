...
title: Gravity
alias:
  - Attraction,Focal-Point,Tension
---
...
[[Energy.md#Power|power]] may curve any given [[Action.md|action space]] or
[[Intention.md#Rule-Sets|rule set]]. For that reason its underlying dynamics
...
> [!info] Info
>
> More content about different **gravitational** phenomena must be added. Topics
> can be freely chosen based on the author's preferences, as long as the content
